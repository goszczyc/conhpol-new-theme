...
function pagination_bar($custom_query)
{
	...
	if ($total_pages > 1) {
		...
		echo paginate_links(array(
			...
			'total' => $total_pages,
			'prev_text' => '<span class="arrow block relative w-3 h-0.5 mr-3 before:top-1/2 bg-black before:absolute before:right-full before:border-r-4 before:border-t-4 before:border-b-4 before:border-t-transparent before:border-b-transparent before:border-r-black before:-translate-y-1/2 transition-colors before:transition-colors"></span><span class="hidden xs:inline">Poprzednia strona</span>',
			'next_text' => '<span class="hidden xs:inline">Następna strona</span><span class="arrow block relative w-3 h-0.5 ml-3 before:top-1/2 bg-black before:absolute before:left-full before:border-l-4 before:border-t-4 before:border-b-4 before:border-t-transparent before:border-b-transparent before:border-l-black before:-translate-y-1/2 transition-colors before:transition-colors"></span>',
		));
	}
}
