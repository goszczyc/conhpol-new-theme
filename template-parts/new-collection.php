<div class="container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-3 px-5 mx-auto mb-28">
    ...
    <a href="<?php //TODO: ADD LINK TO NEWEST COLLECTION 
                ?>" class="col-span-1 md:col-span-2 lg:col-span-7 py-12 md:py-8 bg-center bg-cover bg-no-repeat" <?php if ($bg = get_field('new_collection_bg')) : ?> style="background-image: url('<?php echo esc_url($bg); ?>')" <?php endif; ?>>
