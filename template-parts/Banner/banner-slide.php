...
<?php if ($slide_type == 'img_txt') : ?>
    ...
    <div class="swiper-slide">
        <div class="grid sm:grid-cols-12 items-center gap-10">
            ...
            <?php endif; ?>
            <div class="flex flex-col items-center relative sm:items-start opacity-0 col-start-1 col-span-full sm:col-start-8 sm:col-span-5 row-start-1 py-20 animate-fadeIn ">
                <?php if ($heading = get_sub_field('heading')) : ?>
                    <h2 class="leading-snug uppercase font-bold text-white mb-[0.73em] text-2xl  sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl">
                        <?php echo $heading; ?>
